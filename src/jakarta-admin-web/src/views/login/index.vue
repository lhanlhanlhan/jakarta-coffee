  ...
  <div class="login-container">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" auto-complete="on" label-position="left">
      ...
      <div class="title-container">
        <h1 class="title">
          <svg-icon icon-class="thejaback" />
        </h1>
        <h4 class="title-annotation">
          Jakarta Coffee House Management System
        </h4>
      </div>
      ...
      <div class="tips">
        <span style="margin-right:20px;">If password and/or username is forgotten, contact the website administrator.</span>
      </div>
