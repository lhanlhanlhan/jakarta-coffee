<template>
  <div>
    <y-shelf title="账户资料">
      <span slot="right"><y-button text="启用/关闭编辑模式" style="margin: 0" @btnClick="openEditing"></y-button></span>
      <div slot="content">
        <div class="info">
          <el-row>
            <el-col :span="10">
            ...
            <el-col :span="14">
              <el-tabs>
                ...
                <el-tab-pane label="密码">
                  <el-form ref="passwordReq" :model="passwordReq" auto-complete="on" label-position="left">
                    <el-form-item prop="currPass" label="当前密码">
                      <el-input v-model.trim="passwordReq.old_pass" show-password :disabled="isDisabled"/>
                    </el-form-item>
                    <el-form-item prop="newPass" label="新密码">
                      <el-input v-model.trim="passwordReq.new_pass" show-password :disabled="isDisabled"/>
                    </el-form-item>
                    <el-form-item prop="newPassAgain" label="确认密码">
                      <el-input v-model.trim="passwordReq.again_pass" show-password :disabled="isDisabled"/>
                    </el-form-item>
                    <y-button style="width: 100px; height: 40px; line-height: 40px"
                              text="更新密码"
                              classStyle="disabled-btn"
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      resetAllPass () {
        // 重置个人密码
        this.passwordReq.old_pass = ''
        this.passwordReq.new_pass = ''
        this.passwordReq.again_pass = ''
      },
      uploadImg (e) {
