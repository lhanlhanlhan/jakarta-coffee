    ...
    <div>
      <header class="w">
        <div class="w-box">
          <div class="nav-logo">
            <h1>
              <router-link to="/" title="Jakarta Home"></router-link>
            </h1>
          </div>
          <div class="right-box">
            <div class="nav-list">
                  ...
                  <div class="nav-user-list">
                    <ul>
                      ...
                      <li class="nav-user-avatar">
                        <div>
                          <span class="avatar" :style="{ backgroundImage:'url('+basicAvatarUrl+')' }">
                          </span>
                        </div>
                              ...
                              <div class="cart-item-inner">
                                <router-link :to="'goodsDetails?productId=' + item.item_id">
                                  <div class="item-thumb">
                                    <img :src="item.photo_uri === 'null' ? basicFoodUrl : item.photo_uri">
                                  </div>
                                </router-link>
                                <div class="item-desc">
                                  <div class="cart-cell">
                                ...
                                <div class="del-btn del" @click="delGoods(item.item_id)">删除</div>
                              </div>
                            </div>
                          </li>
                        </ul>
          ...
          <div class="nav-sub-wrapper" :class="{fixed:st}">
            <div class="w">
              <ul class="nav-list">
                ...
                <li>
                  <router-link to="/goods">菜单</router-link>
                </li>
                <li>
                  <router-link to="/user">我的账户 ({{this.email}}) </router-link>
                </li>
              </ul>
            </div>
          </div>
...
<script>
  ...
  import { delFromCart, fetchCart } from '../api/cart'
  ...
  export default {
    ...
    methods: {
      ...
      // 购物车显示
      cartShowState (state) {
        this.SHOW_CART({ showCart: state, timeout: null })
      },
      // 登陆时获取一次购物车商品 LH
      _getCartList () {
        fetchCart().then(res => {
...
<style lang="scss" rel="stylesheet/scss" scoped>
  ...
  .w-box {
    ...
    h1 {
      ...
      align-items: center;
      > a {
        background: url(/static/images/jakarta-text-white.png) no-repeat 50%;
